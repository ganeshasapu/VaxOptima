...
def algorithm_runner_fixed(num_timestamps: int, num_best_genes: int, mutation_rate: float, crossover_rate: float, replication_rate: float, chromosome_size: int, num_chromosomes: int, population: int, max_shipment_time: int):
    """Runs the algorithm"""
...
if __name__ == "__main__":
    ...
    algorithm_runner_fixed(num_timestamps=30, num_best_genes=10, mutation_rate=0.6, crossover_rate=0.2, replication_rate=0.2, chromosome_size=100, num_chromosomes=100, population=100000, max_shipment_time=3)
