...
if __name__ == "__main__":
    timestamps_vaccine_amount = ga.generate_timestamp_vaccine_amount(num_timestamps=10)
    ...
    for country in countries:
        edges[country] = wg.Edge(importer=countries[country], shipment_time=random.randint(1, 30))
    ...
    simulation = ga.GeneticAlgorithm(mutation_rate=0.5, crossover_rate=0.3, replication_rate=0.2, chromosome_size=50, num_chromosomes=50, world=world, num_timestamps=50)
