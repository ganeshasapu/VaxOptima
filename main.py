...
if __name__ == "__main__":
    ...
    algorithm_runner_fixed(num_timestamps=500, num_best_genes=5, mutation_rate=0.3, crossover_rate=0.4, replication_rate=0.3, chromosome_size=50, num_chromosomes=100)
