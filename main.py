...
if __name__ == "__main__":
    ...
    algorithm_runner_fixed(num_timestamps=100, num_best_genes=5, mutation_rate=0.5,
                           crossover_rate=0.4, replication_rate=0.1, chromosome_size=50, num_chromosomes=100)
